...
st.caption("Takeaway: This allows readers to get a general sense of the points trend of teams between seasons. There seems to be some positive correlation between 2023-2024 and 2024-2025 performance, but past performance alone cannot predict current performance. Liverpool, Arsenal, and Man City seem to have dominated both seasons.")
...
st.caption("Takeaway: Some teams that did the best in the 2024-2025 seasons actually have fewer points than they did in the 2023-2024 season. The middle-performing teams seem to generally improved from the previous season, especially Nottingham Forest. Teams that did the worse in 2024-2025 tend to have a point decrease from the previous season. This indicates that improvement or lack of improvement from the previous season cannot predict future performance.")
